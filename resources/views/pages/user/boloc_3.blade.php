        ...
        <div class="row">
            ...
            <div class="col-sm-9 padding-right panel">
                <div class="features_items panel-body">
                    @if (is_null($sidebar_tl) and is_null($sidebar_qg))
                        ...
                        @endforeach
                    @endif
                    @if ($sidebar_tl and is_null($sidebar_qg))
                        @foreach ($sidebar_tl as $mv)
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                        ...
                        @endforeach
                    @endif
                    @if (is_null($sidebar_tl) and $sidebar_qg)
                        @foreach ($sidebar_qg as $mv)
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
