<!DOCTYPE html>
<head>
    <title>Admin Movies Tickets</title>
...
<div class="log-w3">
    <div class="w3layouts-main">
        ...
        ?>
        <form action="{{URL::to('/admin/admin-home')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <input type="text" class="ggg" name="email" placeholder="E-MAIL/USERNAME">
